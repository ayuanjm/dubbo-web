package com.sunyur.purchaser.apply.param;
 ...
 * Description:
 */
public class PurchaseApplyClassParam implements Serializable {
    private static final long serialVersionUID = -9030574464056740386L;
    /**
     * 主键id
     */
    private Long id;
